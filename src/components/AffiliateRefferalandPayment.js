...
import Datatable11 from '../Datatable/Datatable11';
import { IoIosArrowForward } from "react-icons/io";
import {BiDotsVerticalRounded} from 'react-icons/bi';

function AffiliateRefferalandPayment() {
  return (
            ...
            <div class="row">
                ...
                <ul className="breadcrumb breadcrumb-style ">
                                    <li className="breadcrumb-item">
                                        <h4 className="page-title">Affiliate Refferal and Payment</h4>
                                    </li>
                                    ...
                                    <li className="DashboardActive">
                                        <IoIosArrowForward className="Arrow" />
                                        Affiliate Refferal and Payment</li>
                                </ul>
                </div>
            </div>
        </div>
...
export default AffiliateRefferalandPayment